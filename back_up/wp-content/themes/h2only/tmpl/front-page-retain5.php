<?php
/**
 * Template Name: Front Page Retain day5
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 5:<br/><strong>Weekend willpower</strong></h3>
                    <p>
                    You&rsquo;re heading towards your first Saturday night of H2Only. Mix a water-only mocktail and stay strong. You can do this.
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day5.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>The Mocktail Hour:<br/><strong>Mine&rsquo;s a Water Royale</strong></h3>

                    <p>The perfect brunch accompaniment. </p>
                    
                  <ul>
                    <h5><strong>RECIPE:</strong></h5>
                     <li>10ml pure H<sub>2</sub>O</li>
                     <li>65ml fizzy water</li>
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 5:<br/><strong>Weekend willpower</strong></h3>
                    <p>You&rsquo;re heading towards your first Saturday night of H2Only. Mix a water-only mocktail and stay strong. You can do this.
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day5.png' ?>" />
            ...
            <!-- MOCKTAIL OF THE DAY -->
             <div class="row water-bg water-line-top mocktail-of-the-day">
                ...
                <div <?php echo post_class('col-sm-6')?> >
                    ...
                    <strong>Mine&rsquo;s a Water Royale</strong></h3>
