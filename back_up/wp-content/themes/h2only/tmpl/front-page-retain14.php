<?php
/**
 * Template Name: Front Page Retain day14
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 14:<br/><strong>Pour another water mocktail</strong></h3>
                    <p>
If you&rsquo;re dreaming of tea bags, coffee beans and a long, cool beer, you won&rsquo;t have to dream for much longer. Sip your final H<sub>2</sub>O from a martini glass and enjoy, because once you&rsquo;ve sent us the money you&rsquo;ve raised, you&rsquo;ll be crowned Master of self-control. 
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day14.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>The Mocktail Hour:<br/>                    
                        <strong>Water Collins. Straight up.</strong></h3>


                    <p>It&rsquo;s a classic, made to be sipped and enjoyed slowly. </p>
                    
                    <ul>
                    <h5><strong>RECIPE:</strong></h5>
                     <li>20ml blended Icelandic water</li>
                     <li>30ml pure H<sub>2</sub>O</li>
                     <li>Poured over ice</li>
                    </ul>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/watercollins.png' ?>" />
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 14:<br/><strong>Pour another water mocktail</strong></h3>
                    <p>
If you&rsquo;re dreaming of tea bags, coffee beans and a long, cool beer, you won&rsquo;t have to dream for much longer. Sip your final H<sub>2</sub>O from a martini glass and enjoy, because once you&rsquo;ve sent us the money you&rsquo;ve raised, you&rsquo;ll be crowned Master of self-control. 
                    </p>
                </div>
            ...
            <!-- MOCKTAIL OF THE DAY -->
             <div class="row water-bg water-line-top mocktail-of-the-day">
                <div <?php echo post_class('col-sm-6')?> >
                    ...
                    src="<?php echo get_template_directory_uri().'/img/watercollins.png' ?>" /><p></p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
