<?php
/**
 * Template Name: Front Page Retain day12
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 12:<br/><strong>You&rsquo;re a Scholar!</strong></h3>
                    <p>
You&rsquo;ve climbed the ranks and you&rsquo;re still going strong. Share your success and see how much more money you can raise.                    
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day12.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 12:<br/><strong>You&rsquo;re a Scholar!</strong></h3>
                    <p>
You&rsquo;ve climbed the ranks and you&rsquo;re still going strong. Share your success and see how much more money you can raise.                    
                    </p>
                </div>
