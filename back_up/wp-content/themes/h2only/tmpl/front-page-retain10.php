<?php
/**
 * Template Name: Front Page Retain day10
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 10:<br/><strong>Flavour. Caffeine. Juice. </strong></h3>
                    <p>
Missing your long lost friend, the teapot? It&rsquo;s time to get creative. How about eating a polo and then drinking some hot H<sub>2</sub>O? Mint tea! Or eating a segment of orange, then taking a few sips of water. Orange juice!                    
                    
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day10.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 10:<br/><strong>Flavour. Caffeine. Juice. </strong></h3>
                    <p>
Missing your long lost friend, the teapot? It&rsquo;s time to get creative. How about eating a polo and then drinking some hot H<sub>2</sub>O? Mint tea! Or eating a segment of orange, then taking a few sips of water. Orange juice!                    
