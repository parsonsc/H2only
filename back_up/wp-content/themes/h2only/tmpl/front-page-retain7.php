<?php
/**
 * Template Name: Front Page Retain day7
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 7:<br/><strong>Seven days of sipping</strong></h3>
                    <p>It&rsquo;s a new week, and the chance to notch up some extra cash for the cause. Volunteer to make the tea for everyone at work in exchange for a donation. If they don&rsquo;t take pity on you for drinking hot water only, shame on them. 
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day7.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 7:<br/><strong>Seven days of sipping</strong></h3>
                    <p>It&rsquo;s a new week, and the chance to notch up some extra cash for the cause. Volunteer to make the tea for everyone at work in exchange for a donation. If they don&rsquo;t take pity on you for drinking hot water only, shame on them. 
