<?php
/**
 * Template Name: Front Page Retain day11
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 11:<br/><strong>Fundraising Friday</strong></h3>
                    <p>
Make this your final push to raise as much as you can to help our lifesavers at sea. Share your challenges with friends again on Facebook and Twitter. Ask one last time for their support.                    
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day11.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 11:<br/><strong>Fundraising Friday</strong></h3>
                    <p>
Make this your final push to raise as much as you can to help our lifesavers at sea. Share your challenges with friends again on Facebook and Twitter. Ask one last time for their support.                    
