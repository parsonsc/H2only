...
// RANGE SLIDERS
	...
	// UPDATE CALORIES	
		...
		var pop 	= 	+$("#pop").val() * 139;
		var juice 	= 	+$("#juice").val() * 111;
		var tea 	=	+$("#tea").val() * 2;
		var coffee	= 	+$("#coffee").val() * 190;

		var calories = pints + pop + juice + tea + coffee;
	...
	// UPDATE COST	
		...
		var pints 	= 	+jQuery("#pints").val() * 3;
		var pop 	= 	+jQuery("#pop").val() * 1.50;
		var juice 	= 	+jQuery("#juice").val() * 1.10;
		var tea 	=	+jQuery("#tea").val() * 1.45;
		var coffee	= 	+jQuery("#coffee").val() * 2.45;

		var cost = pints + pop + juice + tea + coffee;

		jQuery(".calories-cost").text('Cost: £' + cost.toFixed(2));
	}
	...
	function setCalorieCounter() {
		...
		var pints 	= 	$("#pints").val();
		$(".pint.counter").text('PINTS' + ' x ' + pints);

		var pop 	= 	+$("#pop").val();
		$(".pop.counter").text('POP' + ' x ' + pop);

		var juice 	= 	+$("#juice").val();
		$(".juice.counter").text('JUICE' + ' x ' + juice);

		var tea 	=	+$("#tea").val();
		$(".tea.counter").text('TEA' + ' x ' + tea);

		var coffee	= 	+$("#coffee").val();
		$(".coffee.counter").text('COFFEE' + ' x ' + coffee);
	}
