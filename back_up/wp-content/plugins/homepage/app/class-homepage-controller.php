...
require_once 'class-homepage-model.php';
require_once 'class-homepage-view.php';
...
class Homepage_Controller {
	...
	function __construct() {
		...
		$this->model = new Homepage_Model($this);	
		$this->view = new Homepage_View($this);
		$this->init();
	}
