    ...
    $.fn.wonderpluginslider = function(options) {
        ...
        AmazingSlider.prototype = {initData: function(onSuccess) {
                ...
                if (instance.options.showtimer)
                    $(".amazingslider-timer-" + instance.id, instance.container).css({display: "block",position: "absolute",left: "0px",top: instance.options.timerposition == "bottom" ? "" : "0px",bottom: instance.options.timerposition == "bottom" ? "0px" : "",width: "0%",height: instance.options.timerheight + 
                ...
                if (this.options.enabletouchswipe)
                    ...
                    this.container).touchSwipe({preventWebBrowser: false,swipeLeft: function() {
                            instance.slideRun(-1)
                        },swipeRight: function() {
                            instance.slideRun(-2)
                        }});
                ...
                if (ASPlatforms.isIE6789())
                    isHTML5 = false;
                else if ((ASPlatforms.isFirefox() || 
                ASPlatforms.isOpera()) && !webmhref)
                    isHTML5 = false;
                if (isHTML5) {
                    ...
                    this.embedFlash($videoWrapper, "100%", "100%", this.options.jsfolder + "html5boxplayer.swf", "transparent", {width: "100%",height: "100%",hidecontrols: this.options.videohidecontrols ? 
                ...
                !ASPlatforms.isIOS() && !ASPlatforms.isAndroid()) {
                    ...
                    new YT.Player("amazingslider-video-" + this.id, {width: instance.options.width,height: instance.options.height,videoId: id,playerVars: {"html5": 1,"autoplay": 1,"rel": 0,"autohide": 1,"wmode": "transparent","controls": instance.options.videohidecontrols ? "0" : "1","showinfo": instance.options.videohidecontrols ? 
                            "0" : "1"},events: {"onReady": function(event) {
            ...
            createArrows: function() {
                ...
                $rightArrow.css({overflow: "hidden",position: "absolute",cursor: "pointer",width: this.options.arrowwidth + "px",height: this.options.arrowheight + "px",right: this.options.arrowmargin + "px",
                ...
                $(imgLoader).load(function() {
                    ...
                    $box.amazingsliderTransition(instance.id, $imgPrev, $imgCur, {effect: transitioneffect,direction: slideDirection,duration: instance.options.transitionduration,easing: instance.options.transitioneasing,imgmarginleft: instance.curImageMarginLeft,imgmargintop: instance.curImageMarginTop,imgmaxwidth: instance.curImageMaxWidth,crossfade: instance.options.crossfade,fade: instance.options.fade,slide: instance.options.slide,elastic: instance.options.elastic,
                        slice: instance.options.slice,blinds: instance.options.blinds,threed: instance.options.threed,threedhorizontal: instance.options.threedhorizontal,blocks: instance.options.blocks,shuffle: instance.options.shuffle}, function() {
                        instance.isAnimating = false;
                    ...
                    $(".amazingslider-play-" + instance.id, instance.container).css({display: instance.elemArray[instance.curElem][ELEM_VIDEO].length > 
                        0 ? "block" : "none"})
                });
        ...
        this.each(function() {
            ...
            if ($(this).data("textformat") && typeof HOMEPAGE_TEXT_EFFECT_FORMATS !== "undefined")
                if ($(this).data("textformat") in HOMEPAGE_TEXT_EFFECT_FORMATS)
                    this.options = $.extend({}, HOMEPAGE_TEXT_EFFECT_FORMATS[$(this).data("textformat")], this.options);
            if ($(this).data("skin") && typeof HOMEPAGE_SKIN_OPTIONS !== "undefined")
                if ($(this).data("skin") in HOMEPAGE_SKIN_OPTIONS)
                    this.options = $.extend({}, HOMEPAGE_SKIN_OPTIONS[$(this).data("skin")], this.options);
            var instance = this;
            $.each($(this).data(), 
            function(key, value) {
