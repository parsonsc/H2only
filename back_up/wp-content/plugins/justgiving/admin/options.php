...
<div id="framework_wrap" class="wrap">
    ...
    <div id="content_wrap">
		...
		<option value="https://api-staging.justgiving.com/" <?php if ($wppb_generalSettings['ApiLocation'] == 'https://api-staging.justgiving.com/') echo 'selected="selected"';?>><?php _e('Staging', 'justgiving');?></option>
