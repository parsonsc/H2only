<?php
/**
 * Template Name: Front Page Retain day6
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 6:<br/><strong>Rest and rehydrate</strong></h3>
                    <p>What a week. It was water-fuelled and probably tougher than you thought. But you got this far. We&rsquo;re helping to save lives at sea together, so give yourselves a pat on the back.
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day6.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>The Mocktail Hour:<br/><strong>Another Waterarita?</strong></h3>

                    <p>Looks like holiday in a glass. Tastes like H2Only. </p>
                    
                    <ul>
                    <h5><strong>RECIPE:</strong></h5>
                    <li>35ml water-flavoured water</li>
                    <li>50ml chilled H<sub>2</sub>O</li>
                    <li>A cocktail umbrella, to garnish</li>
                    </ul>
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 6:<br/><strong>Rest and rehydrate</strong></h3>
                    <p>What a week. It was water-fuelled and probably tougher than you thought. But you got this far. We&rsquo;re helping to save lives at sea together, so give yourselves a pat on the back.
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
            ...
            <!-- MOCKTAIL OF THE DAY -->
             <div class="row water-bg water-line-top mocktail-of-the-day">
                ...
                <div <?php echo post_class('col-sm-6')?> >
                    ...
                    <strong>Another Waterarita?</strong></h3>
