<?php
/**
 * Template Name: Front Page Retain day8
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 8:<br/><strong>You&rsquo;ve been promoted</strong></h3>
                    <p>
You&rsquo;re sailing through this challenge! And even if you&rsquo;ve hit a few choppy moments along the way, you&rsquo;re still going strong. So much so, you&rsquo;ve been awarded the Teacher badge.                    
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day8.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 8:<br/><strong>You&rsquo;ve been promoted</strong></h3>
                    <p>
You&rsquo;re sailing through this challenge! And even if you&rsquo;ve hit a few choppy moments along the way, you&rsquo;re still going strong. So much so, you&rsquo;ve been awarded the Teacher badge.                    
