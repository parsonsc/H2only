<?php
/**
 * Template Name: Front Page Retain day4
 *
 */
        ...
        while ($homePageBits->have_posts()): 
            ...
            <div class="row water-bg water-line-top day1">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>Day 4:<br/><strong>Win the battle of self-control</strong></h3>
                    <p>
                    4 days in can be tough. But don&rsquo;t let a little water-based wobble get you down. Eat some delicious juicy fruit. Go for a walk. Take up knitting. Anything to keep you H2-On-track.
                    </p>

                    <p>
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day4.png' ?>" />
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
                    <h3>The Mocktail Hour:<br/><strong>The Waterpolitan</strong></h3>

                    <p>The glamorous way to drink H2Only</p>
            ...
            <div class="row water-bg water-line-top daily-update">
                <div <?php echo post_class('col-sm-6')?> >
                    <h3 class="alignCenter">Day 4:<br/><strong>Win the battle of self-control</strong></h3>
                    <p>4 days in can be tough. But don&rsquo;t let a little water-based wobble get you down. Eat some delicious juicy fruit. Go for a walk. Take up knitting. Anything to keep you H2-On-track.
                    </p>
                </div>
                <div <?php echo post_class('col-sm-6')?> >
                    <img class="full-img-responsive" src="<?php echo get_template_directory_uri().'/img/day4.png' ?>" />
            ...
            <!-- MOCKTAIL OF THE DAY -->
             <div class="row water-bg water-line-top mocktail-of-the-day">
                ...
                <div <?php echo post_class('col-sm-6')?> >
                    ...
                    <strong>The Waterpolitan</strong></h3>
