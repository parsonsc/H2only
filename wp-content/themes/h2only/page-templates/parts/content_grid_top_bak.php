        ...
        <ul>            
            <li class="block right">
                ...
                <article class="grid_copy">
                    ...
                    <a href="http://rnli.org/aboutus/Pages/About-us-new.aspx/" class="site_cta">MORE ABOUT RNLI</a>
                </article>                      
            </li>
            <li class="block left">
            ...
            <li class="block left">
                <h3 class="daily_challenge">Daily challenge</h3>
                <img src="<?php echo get_template_directory_uri(); ?>/img/Challenge_panel.jpg" alt="Daily challenge">  
                <article class="grid_copy">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ut egestas neque. Nulla sed nisi mi. Phasellus id erat vel odio efficitur imperdiet non vel metus. Nam et nisl id arcu congue maximus ac ut risus. </p>  
                    <a href="<?php echo get_permalink(194); ?>" class="site_cta">CTA TBC</a>   
                </article>
                
            </li>
            <li class="block right">
                <h3>Need a lifeline?</h3>
                <img src="<?php echo get_template_directory_uri(); ?>/img/h2only_crew.jpg" alt="Need a lifeline?"> 
                <article class="grid_copy">
                    <p>If you’ve got a special occasion during H<sub class="lower_2">2</sub>Only – a celebration that calls for a glass of fizz – don’t panic. Pay a £24 penalty and enjoy 24 hours off H2Only. We’ll tell you how to get your lifeline when H<sub class="lower_2">2</sub>Only begins at 5pm on 2 June.</p>  
                    <a href="https://www.justgiving.com/h2onlysos/donate/?amount=24.00&reference=h2owebsite" class="site_cta">Get a lifeline</a>   
                </article>                      
            </li>
            ...
            <li class="block right">
                ...
                <article class="grid_copy">
                    <p>The H<sub class="lower_2">2</sub>Only app will be available on 26 May. It’ll be your buddy for 10 days, with fun challenges to keep you going and a live stream so you can keep track of your fellow H2Onlies. Sign up for the challenge and we’ll let you know when the app is ready.</p> 
                    <a href="<?php echo get_permalink(); ?>" class="site_cta">Download the app</a>
                </article>                      
            </li>
        </ul>
    </div>
