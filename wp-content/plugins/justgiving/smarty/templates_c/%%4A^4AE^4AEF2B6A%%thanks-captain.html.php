<?php /* Smarty version 2.6.28, created on 2015-04-09 10:03:26
         compiled from thanks-captain.html */ ?>
<div class="thank_you">
...
/img/thanks_header.png" alt="Thanks for taking the h2only challenge" class="thanks_hero">
        <h2>Thanks for becoming an H2Only captain</h2>
        <h2>Get ready for 10 days. 100% water.</h2>
        <p>It’s going to be a challenge. But we’ll be with you all the way, helping you lead crew and keep your heads above water. </p>
        <p>When the cravings get too much, just remember that you’re helping the RNLI save lives at sea. So stay strong, and good luck.</p>
