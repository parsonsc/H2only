<?php /* Smarty version 2.6.28, created on 2015-04-08 15:47:50
         compiled from register.html */ ?>
            <header class="sign_up_banner">
                <div class="inner_content">
                    <h2>Away we go!</h2>
                    <p class="title_tag">Enter your details here and start raising money to help the RNLI save lives at sea.</p>
                    <p class="required_message">Lifejackets on. You must fill in the following:</p>
                </div>
            </header>
