...
function jg_front_end_create_page($atts){
    ...
    extract(shortcode_atts(array('paid'=> 0, 'forgot'=> 0, 'display' => true, 'redirect' => '', 'teampage' => '', 'submit' => 'page', 'create' => '', 'thanks' => '','advocate' => '', 'template' => ''), $atts));
    $user = '';
    $pass = '';
    $errors = array();
    ...
    if ( 'POST' == $_SERVER['REQUEST_METHOD'] &&
        ...
        if (!$founderror)
        {
            ...
            if (!$pageExists){
                ...
                */
                $cc5 = array(
                    $_POST['dob'],$_POST['heardabout'],$_POST['work'],($_POST['advocate'] == 1)? 'y':'n',($_POST['packbypost'] == 1)? 'y':'n'
                );
